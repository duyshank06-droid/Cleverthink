document.addEventListener("DOMContentLoaded", function () {
    ...
    let feedbacks = [
        { id: 1, name: "Nguyễn Văn An", rating: 5, content: "Anh Duy dạy cực kỳ dễ hiểu, từ một đứa mất gốc tiếng Anh mà nay em đã tự tin đạt 8.5 điểm trên lớp.", heart: true },
        { id: 2, name: "Trần Minh Thư", rating: 5, content: "Chị Hoàng siêu dễ thương và kiên nhẫn. Lộ trình ôn thi vào 10 rất sát thực tế.", heart: false },
        { id: 3, name: "Lê Hoàng Long", rating: 4, content: "Thầy Tín dạy Lý cuốn lắm ạ, không bị khô khan lý thuyết mà tập trung giải bài tập rất nhanh.", heart: false }
    ];
